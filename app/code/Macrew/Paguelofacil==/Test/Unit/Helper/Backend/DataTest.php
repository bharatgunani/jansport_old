 ...
 */
namespace Macrew\Paguelofacil\Test\Unit\Helper\Backend;
...
{
    /**
     * @var \Macrew\Paguelofacil\Helper\Backend\Data
     */
    ...
    protected function setUp()
    {
        ...
        $this->dataHelper = $helper->getObject(
            'Macrew\Paguelofacil\Helper\Backend\Data',
            [
                'context' => $contextMock,
    ...
    public function testGetPlaceOrderAdminUrl()
    {
        $this->urlBuilderMock->expects($this->once())
            ->method('getUrl')
            ->with('adminhtml/paguelofacil_directpost_payment/place')
    ...
    public function testGetRedirectIframeUrl()
    {
        ...
        $this->urlBuilderMock->expects($this->once())
            ->method('getUrl')
            ->with('adminhtml/paguelofacil_directpost_payment/redirect', $params)
            ->willReturn('some value');
    ...
    public function testGetRelayUrl()
    {
        ...
        $this->assertSame(
            'http://base.url/paguelofacil/directpost_payment/backendResponse',
