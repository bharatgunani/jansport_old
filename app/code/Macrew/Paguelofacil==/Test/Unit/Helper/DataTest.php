 ...
 */
namespace Macrew\Paguelofacil\Test\Unit\Helper;
...
class DataTest extends \PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->dataHelper = $helper->getObject(
            'Macrew\Paguelofacil\Helper\Data',
    ...
    public function getMessagesParamDataProvider()
    {
        ...
        return [
            [
                ...
                . 'Paguelofacil Transaction ID ' . self::TRID . '. Addition message.',
            ],
            [
                'AUTH_CAPTURE',
                $amount,
                ...
                . 'Paguelofacil Transaction ID ' . self::TRID . '. some exception'
            ],
            [
                'CREDIT',
                false,
    ...
    public function testGetRelayUrl()
    {
        ...
        $this->assertSame(
            'http://base.url/paguelofacil/directpost_payment/response',
