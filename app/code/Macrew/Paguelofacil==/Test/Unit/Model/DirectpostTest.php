...
use Macrew\Paguelofacil\Model\Directpost;
use Macrew\Paguelofacil\Model\TransactionService;
use Macrew\Paguelofacil\Model\Request;
use Macrew\Paguelofacil\Model\Directpost\Request\Factory;
...
class DirectpostTest extends \PHPUnit_Framework_TestCase
{
    ...
    /**
     * @var \Macrew\Paguelofacil\Helper\Data|\PHPUnit_Framework_MockObject_MockObject
     */
    protected $dataHelperMock;

    /**
     * @var \Macrew\Paguelofacil\Model\Directpost\Response\Factory|\PHPUnit_Framework_MockObject_MockObject
     */
    ...
    /**
     * @var \Macrew\Paguelofacil\Model\Directpost\Response|\PHPUnit_Framework_MockObject_MockObject
     */
    ...
    /**
     * @var \Macrew\Paguelofacil\Model\Directpost\Request\Factory|\PHPUnit_Framework_MockObject_MockObject
     */
    ...
    protected function setUp()
    {
        ...
        $this->paymentMock = $this->getMockBuilder('Magento\Sales\Model\Order\Payment')
            ...
            ->getMock();
        $this->dataHelperMock = $this->getMockBuilder('Macrew\Paguelofacil\Helper\Data')
            ->disableOriginalConstructor()
            ->getMock();
        ...
        $this->transactionServiceMock = $this->getMockBuilder('Macrew\Paguelofacil\Model\TransactionService')
            ->disableOriginalConstructor()
        ...
        $this->directpost = $helper->getObject(
            'Macrew\Paguelofacil\Model\Directpost',
            [
    ...
    public function testGetConfigValue()
    {
        ...
        $this->scopeConfigMock->expects($this->once())
            ->method('getValue')
            ->with('payment/paguelofacil_directpost/' . $field)
    ...
    public function testSetDataHelper()
    {
        ...
        $helperDataMock = $this->getMockBuilder('Macrew\Paguelofacil\Helper\Backend\Data')
            ->disableOriginalConstructor()
            ->getMock();
    ...
    public function testAuthorize()
    {
        ...
        $this->scopeConfigMock->expects($this->any())
            ->method('getValue')
            ->with('payment/paguelofacil_directpost/payment_action', 'store', null)
    ...
    public function testGetCgiUrl()
    {
        ...
        $this->scopeConfigMock->expects($this->any())
            ->method('getValue')
            ->with('payment/paguelofacil_directpost/cgi_url', 'store', null)
            ->willReturn($url);
    ...
    protected function prepareTestValidateResponse($transMd5, $login, $isValidHash)
    {
        $this->scopeConfigMock->expects($this->any())
            ...
            ->willReturnMap(
                [
                    ['payment/paguelofacil_directpost/trans_md5', 'store', null, $transMd5],
                    ['payment/paguelofacil_directpost/login', 'store', null, $login]
                ]
            );
    ...
    /**
     * @covers       \Macrew\Paguelofacil\Model\Directpost::fetchTransactionInfo
     *
     * @param $transactionId
     * @param $resultStatus
    ...
    /**
     * @covers \Macrew\Paguelofacil\Model\Directpost::refund()
     * @return void
     */
    ...
    {
        $this->responseFactoryMock = $this->getMockBuilder('Macrew\Paguelofacil\Model\Directpost\Response\Factory')
            ->disableOriginalConstructor()
            ->getMock();
        $this->responseMock = $this->getMockBuilder('Macrew\Paguelofacil\Model\Directpost\Response')
            ->setMethods(
                [
                    'isValidHash',
