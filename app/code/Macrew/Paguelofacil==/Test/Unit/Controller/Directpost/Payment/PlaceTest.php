 ...
 */
namespace Macrew\Paguelofacil\Test\Unit\Controller\Directpost\Payment;

use Macrew\Paguelofacil\Controller\Directpost\Payment\Place;
use Macrew\Paguelofacil\Helper\DataFactory;
use Macrew\Paguelofacil\Model\Directpost\Session as DirectpostSession;
...
class PlaceTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function setUp()
    {
        $this->directpostSessionMock = $this
            ->getMockBuilder('Macrew\Paguelofacil\Model\Directpost\Session')
        ...
        $this->dataFactoryMock = $this
            ->getMockBuilder('Macrew\Paguelofacil\Helper\DataFactory')
            ->disableOriginalConstructor()
            ->getMock();
        ...
        $this->placeOrderController = $this->objectManager->getObject(
            'Macrew\Paguelofacil\Controller\Directpost\Payment\Place',
            [
    ...
    public function textExecuteDataProvider()
    {
        ...
        return [
            ...
            [
                ['method' => 'paguelofacil_directpost'],
                IframeConfigProvider::CHECKOUT_IDENTIFIER,
                1,
                1,
                $objectSuccess
