 ...
 */
namespace Macrew\Paguelofacil\Test\Unit\Controller\Adminhtml\Paguelofacil\Directpost\Payment;

use Macrew\Paguelofacil\Controller\Adminhtml\Paguelofacil\Directpost\Payment\Redirect;
...
class RedirectTest extends \PHPUnit_Framework_TestCase
{
    ...
    /**
     * @var \Macrew\Paguelofacil\Helper\Backend\Data|\PHPUnit_Framework_MockObject_MockObject
     */
    protected $helperMock;

    protected function setUp()
    {
        $this->directpostSessionMock = $this->getMockBuilder('Macrew\Paguelofacil\Model\Directpost\Session')
            ->setMethods([
        ...
        $this->objectManagerMock->expects($this->atLeastOnce())
            ->method('get')
            ->willReturnMap([
                ['Macrew\Paguelofacil\Model\Directpost\Session', $this->directpostSessionMock],
        ...
        $this->helperMock = $this->getMockBuilder('Macrew\Paguelofacil\Helper\Backend\Data')
