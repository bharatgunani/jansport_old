...
use Macrew\Paguelofacil\Model\Request as PaguelofacilRequest;

/**
 * Paguelofacil request model for DirectPost model
 */
class Request extends PaguelofacilRequest
{
    /**
     * @var string
     */
    ...
    /**
     * Set Paguelofacil data to request.
     *
     * @param \Macrew\Paguelofacil\Model\Directpost $paymentMethod
     * @return $this
     */
    public function setConstantData(\Macrew\Paguelofacil\Model\Directpost $paymentMethod)
    {
        ...
        $this->setXLogin($paymentMethod->getConfigData('login'))
            ->setXMethod(\Macrew\Paguelofacil\Model\Paguelofacil::REQUEST_METHOD_CC)
    ...
    public function setDataFromOrder(
        ...
        \Macrew\Paguelofacil\Model\Directpost $paymentMethod
    ) {
