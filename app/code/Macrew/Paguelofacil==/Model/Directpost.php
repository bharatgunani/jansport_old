...
/**
 * Paguelofacil DirectPost payment method model.
 * @SuppressWarnings(PHPMD.TooManyFields)
 * @SuppressWarnings(PHPMD.CouplingBetweenObjects)
 * @SuppressWarnings(PHPMD.ExcessiveClassComplexity)
 */
class Directpost extends \Macrew\Paguelofacil\Model\Paguelofacil implements TransparentInterface, ConfigInterface
{
    const METHOD_CODE = 'paguelofacil_directpost';
    ...
    /**
     * @var \Macrew\Paguelofacil\Model\Directpost\Response
     */
    protected $response;
     ...
     * @param \Macrew\Paguelofacil\Helper\Data $dataHelper
     * @param Directpost\Request\Factory $requestFactory
     * @param Directpost\Response\Factory $responseFactory
     * @param \Macrew\Paguelofacil\Model\TransactionService $transactionService
    ...
    public function __construct(
        ...
        \Macrew\Paguelofacil\Helper\Data $dataHelper,
        \Macrew\Paguelofacil\Model\Directpost\Request\Factory $requestFactory,
        \Macrew\Paguelofacil\Model\Directpost\Response\Factory $responseFactory,
     ...
     * @return void
     */
    public function setDataHelper(\Macrew\Paguelofacil\Helper\Data $dataHelper)
    {
     ...
     *
     * @param \Macrew\Paguelofacil\Model\Directpost\Response $result
    ...
    /**
     * Return URL on which Paguelofacil server will return payment result data in hidden request.
     *
     * @param int $storeId
     * @return string
     */
     ...
     * Return response.
     *
     * @return \Macrew\Paguelofacil\Model\Directpost\Response
     */
     ...
     * @return \Macrew\Paguelofacil\Model\Directpost\Request
     */
     ...
     *
     * @param array $responseData data from Paguelofacil from $_POST
     * @return void
    ...
    /**
     * Fill payment with credit card data from response from Paguelofacil.
     *
     * @param \Magento\Framework\DataObject $payment
     * @return void
     */
    ...
    /**
     * Check response code came from Paguelofacil.
     *
     * @return true in case of Approved response
     * @throws \Magento\Framework\Exception\LocalizedException In case of Declined or Error response from Paguelofacil
     */
    ...
    /**
     * Check transaction id came from Paguelofacil
     *
    ...
    /**
     * Compare amount with amount from the response from Paguelofacil.
     *
     * @param float $amount
     * @return bool
     */
    ...
    /**
     * Operate with order using information from Paguelofacil.
