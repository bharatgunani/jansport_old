...
class Data extends AbstractHelper
{
    ...
    {
        return $this->_getUrl('paguelofacil/directpost_payment/redirect', $params);
    }
    ...
    public function getTransactionMessage(
        ...
        if ($lastTransactionId !== null) {
            $message[] = __('Paguelofacil Transaction ID %1.', $lastTransactionId);
        }
    ...
    {
        switch ($requestType) {
            case Paguelofacil::REQUEST_TYPE_AUTH_ONLY:
                return __('authorize');
            case Paguelofacil::REQUEST_TYPE_AUTH_CAPTURE:
                return __('authorize and capture');
            case Paguelofacil::REQUEST_TYPE_PRIOR_AUTH_CAPTURE:
                return __('capture');
            case Paguelofacil::REQUEST_TYPE_CREDIT:
                return __('refund');
            case Paguelofacil::REQUEST_TYPE_VOID:
                return __('void');
            default:
                return false;
        }
    ...
    public function getRelayUrl($storeId = null)
    {
        ...
        return $baseUrl . 'paguelofacil/directpost_payment/response';
    }
