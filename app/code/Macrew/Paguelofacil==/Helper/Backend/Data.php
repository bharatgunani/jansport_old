 ...
 */
namespace Macrew\Paguelofacil\Helper\Backend;

use Macrew\Paguelofacil\Helper\Data as FrontendDataHelper;
...
/**
 * Paguelofacil Backend Data Helper
 */
class Data extends FrontendDataHelper
{
    ...
    {
        return $this->_getUrl('adminhtml/paguelofacil_directpost_payment/place', []);
    }
    ...
    {
        return $this->_getUrl('adminhtml/paguelofacil_directpost_payment/redirect', $params);
    }
    ...
    public function getRelayUrl($storeId = null)
    {
        ...
        return $baseUrl . 'paguelofacil/directpost_payment/backendResponse';
    }
}
