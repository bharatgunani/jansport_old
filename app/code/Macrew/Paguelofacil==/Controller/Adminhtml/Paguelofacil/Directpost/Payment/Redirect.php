...
class Redirect extends \Magento\Sales\Controller\Adminhtml\Order\Create
{
     ...
     * @param \Macrew\Paguelofacil\Helper\Backend\Data $helper
     */
    public function __construct(
        ...
        \Macrew\Paguelofacil\Helper\Backend\Data $helper
    ) {
    ...
    {
        $directpostSession = $this->_objectManager->get('Macrew\Paguelofacil\Model\Directpost\Session');
