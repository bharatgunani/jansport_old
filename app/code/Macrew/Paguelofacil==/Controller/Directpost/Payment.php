 ...
 */
namespace Macrew\Paguelofacil\Controller\Directpost;
...
abstract class Payment extends \Magento\Framework\App\Action\Action
{
    ...
    /**
     * @var \Macrew\Paguelofacil\Helper\DataFactory
     */
     ...
     * @param \Macrew\Paguelofacil\Helper\DataFactory $dataFactory
     */
    public function __construct(
        \Magento\Framework\App\Action\Context $context,
        \Magento\Framework\Registry $coreRegistry,
        \Macrew\Paguelofacil\Helper\DataFactory $dataFactory
    ) {
     ...
     * Get session model
     *
     * @return \Macrew\Paguelofacil\Model\Directpost\Session
     */
    protected function _getDirectPostSession()
    {
        return $this->_objectManager->get('Macrew\Paguelofacil\Model\Directpost\Session');
    }
    ...
    protected function _responseAction($area = 'frontend')
    {
        ...
        /* @var $paymentMethod \Macrew\Paguelofacil\Model\DirectPost */
        $paymentMethod = $this->_objectManager->create('Macrew\Paguelofacil\Model\Directpost');
