...
define(
    ...
    function (
        ...
        return Component.extend({
            ...
            $inputBillingControl: $('[name="billing[use_same_shipping]"]'),
            ...
            useShippingAddress: function () {
                if (this.isAddressSameAsShipping()) {
                    ...
                    this.isAddressDetailsVisible(true);
                    this.$billingAddressContainer.hide();
                    this.$inputBillingControl.val(USE_SAME_SHIPPING);
                } else {
                    lastSelectedBillingAddress = quote.billingAddress();
                    quote.billingAddress(null);
                    this.$billingAddressContainer.show();
                    this.$inputBillingControl.val(USE_OTHER_BILLING);
