...
class Configurable extends \Magento\ConfigurableProduct\Block\Product\View\Type\Configurable
{
     ...
     * @return string
     */
    public function getJsonSwatchConfig($page = NULL)
    {
    ...
    protected function addSwatchDataForAttribute(
        ...
        foreach ($options as $optionId => $label) {
            if (isset($swatchesCollectionArray[$optionId])) {
                ...
                $result[$optionId] = $this->addAdditionalMediaData($result[$optionId], $optionId, $attributeDataArray, $page);
            }
        }
     ...
     * @return array
     */
    protected function addAdditionalMediaData(array $swatch, $optionId, array $attributeDataArray, $page = NULL)
    {
		if(is_null($page))
		{
			if (
