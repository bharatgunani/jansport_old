...
return this;},removeChild:function(elem){if(_.isString(elem)){elem=this.getChild(elem);}
if(elem){utils.remove(this._elems,elem);this._updateCollection();}
return this;},hasChild:function(index){return!!this.getChild(index);},requestChild:function(index){var name=this.formChildName(index);return this.requestModule(name);},formChildName:function(index){return this.name+'.'+index;},getRegion:function(name){var regions=this.regions=this.regions||{};if(!regions[name]){regions[name]=[];this.observe.call(regions,name);}
