define(['jquery','underscore','MutationObserver'],function($,_){'use strict';var counter=1,watchers,globalObserver;watchers={selectors:{},nodes:{}};function isElementNode(node){return node.nodeType===1;}
