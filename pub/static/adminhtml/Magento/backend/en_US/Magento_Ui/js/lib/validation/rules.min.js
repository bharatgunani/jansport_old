...
return!(pass.length>0&&pass.length<6);},$.mage.__('Please enter 6 or more characters. Leading or trailing spaces will be ignored.')],"validate-admin-password":[function(value){if(value==null){return false;}
var pass=$.trim(value);if(0===pass.length){return true;}
if(!(/[a-z]/i.test(value))||!(/[0-9]/.test(value))){return false;}
if(pass.length<7){return false;}
return true;},$.mage.__('Please enter 7 or more characters, using both numeric and alphabetic.')],"validate-url":[function(value){if(utils.isEmptyNoTrim(value)){return true;}
...
return true;},$.mage.__('Please enter 6 or more characters. Leading or trailing spaces will be ignored.')],'validate-item-quantity':[function(value,params){var qty=utils.parseNumber(value);var isMinAllowedValid=typeof params.minAllowed==='undefined'||(qty>=utils.parseNumber(params.minAllowed));var isMaxAllowedValid=typeof params.maxAllowed==='undefined'||(qty<=utils.parseNumber(params.maxAllowed));var isQtyIncrementsValid=typeof params.qtyIncrements==='undefined'||(qty%utils.parseNumber(params.qtyIncrements)===0);return isMaxAllowedValid&&isMinAllowedValid&&isQtyIncrementsValid&&qty>0;},''],'equalTo':[function(value,param){return value===$(param).val();},$.validator.messages.equalTo]};});