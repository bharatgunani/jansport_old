...
wrapper.extend(ko,{applyBindings:function(orig,ctx,node){var result=orig(),data;if(!node||node.nodeType!==1){return result;}
data=ctx&&(ctx.$data||ctx);if(data&&data.registerNodes){addBounded(data,node);}
