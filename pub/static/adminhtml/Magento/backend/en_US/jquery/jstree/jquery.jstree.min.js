(function(factory){if(typeof define==='function'&&define.amd){define(["jquery","jquery/jquery.cookie","jquery/jstree/jquery.hotkeys"],factory);}else{factory(jQuery);}}(function($){"use strict";(function(){if(jQuery&&jQuery.jstree){return;}
