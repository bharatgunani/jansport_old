...
directPost.prototype = {
    initialize : function(methodCode, iframeId, controller, orderSaveUrl, cgiUrl, nativeAction) {
        var prepare = function (event, method) {
            if (method === 'paguelofacil_directpost') {
                this.preparePayment();
            }
        };
    ...
    preparePayment : function() {
        ...
        if ($(this.iframeId)) {
            // Temporary solution will be removed after refactoring Paguelofacil (sales) functionality
    ...
    submitAdminOrder : function() {
        ...
        if (editForm.valid()) {
            ...
            if (paymentMethodEl.val() == this.code) {
                ...
                // Temporary solutions will be removed after refactoring Paguelofacil (sales) functionality
